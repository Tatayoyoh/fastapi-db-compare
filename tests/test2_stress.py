...
def test_write_mongo(url_path):
    ...
    for i in range(0,AMOUNT):
        ...
        for parent in parents: # generate parents references separately
            ...
            student['parents'].append(json.loads(r.content)['id'])
...
if __name__ == '__main__':
    # test_write_mongo('/test2/mongo')
    test_write_pgsql('/test2/pgsql')

    # test_read('/test2/mongo')
    test_read('/test2/pgsql')
